...
X402_MAX_PRIORITY_FEE_PER_GAS_WEI = env.int("X402_MAX_PRIORITY_FEE_PER_GAS_WEI", 0)
...
X402_BASE_FEE_PAYER = env.str("X402_BASE_FEE_PAYER", X402_BASE_SIGNER_ADDRESS)
...
X402_SOLANA_FEE_PAYER = env.str("X402_SOLANA_FEE_PAYER", X402_SOLANA_SIGNER_ADDRESS)
...
X402_SKALE_FEE_PAYER = env.str("X402_SKALE_FEE_PAYER", X402_SKALE_SIGNER_ADDRESS)
X402_SKALE_CHAIN_ID = env.int("X402_SKALE_CHAIN_ID", 1187947933)
X402_SKALE_GAS_LIMIT = env.int("X402_SKALE_GAS_LIMIT", 2000000)
