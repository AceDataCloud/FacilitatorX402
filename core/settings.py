...
X402_BAZAAR_ENABLED = env.bool("X402_BAZAAR_ENABLED", False)
X402_BAZAAR_CATALOG_URL = env.str("X402_BAZAAR_CATALOG_URL", "")
X402_BAZAAR_CATALOG_ACCESS_TOKEN = env.str("X402_BAZAAR_CATALOG_ACCESS_TOKEN", "")
X402_BAZAAR_CATALOG_SIGNING_SECRET = env.str("X402_BAZAAR_CATALOG_SIGNING_SECRET", "")
X402_BAZAAR_RESOURCE_ORIGIN = env.str("X402_BAZAAR_RESOURCE_ORIGIN", "https://x402.acedata.cloud").rstrip("/")
X402_BAZAAR_MAX_STALE_SECONDS = env.int("X402_BAZAAR_MAX_STALE_SECONDS", 900)
X402_BAZAAR_PROBE_TIMEOUT_SECONDS = env.float("X402_BAZAAR_PROBE_TIMEOUT_SECONDS", 10.0)
X402_BAZAAR_MAX_CATALOG_BYTES = env.int("X402_BAZAAR_MAX_CATALOG_BYTES", 5 * 1024 * 1024)
X402_BAZAAR_MAX_CHALLENGE_BYTES = env.int("X402_BAZAAR_MAX_CHALLENGE_BYTES", 256 * 1024)
...
X402_SOLANA_RECURRING_ENABLED = env.bool("X402_SOLANA_RECURRING_ENABLED", False)
X402_SOLANA_SUBSCRIPTIONS_PROGRAM = env.str(
    "X402_SOLANA_SUBSCRIPTIONS_PROGRAM",
    "De1egAFMkMWZSN5rYXRj9CAdheBamobVNubTsi9avR44",
)
X402_SOLANA_TOKEN_PROGRAM = env.str(
    "X402_SOLANA_TOKEN_PROGRAM",
