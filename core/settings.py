...
X402_NETWORK = env.str('X402_NETWORK', 'base')
X402_FACILITATOR_URL = env.str('X402_FACILITATOR_URL', '')
X402_FACILITATOR_TIMEOUT_SECONDS = env.int(
    'X402_FACILITATOR_TIMEOUT_SECONDS', 60)
X402_MAX_TIMEOUT_SECONDS = env.int('X402_MAX_TIMEOUT_SECONDS', 120)
X402_USDC_CONTRACT = env.str('X402_USDC_CONTRACT', '')
...
_x402_facilitator_config = {
    'url': X402_FACILITATOR_URL,
    'timeout_seconds': X402_FACILITATOR_TIMEOUT_SECONDS,
...
X402_CONFIG = {
    ...
    'facilitator': _x402_facilitator_config,
}
